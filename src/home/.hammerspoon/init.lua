...
-- Chrome's Gemini launcher shortcut is GLOBAL-only (chrome://settings/ai/gemini
-- has no scope option) and its Ctrl+G default steals the key from terminals,
-- where ctrl+g is the herdr prefix. So the launcher is set to the unused
-- ctrl+alt+cmd+g in Chrome, and this bind recreates ctrl+g as a Chrome-scoped
-- alias for it.
